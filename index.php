...
<body>
  <h1 style="text-align:center; color:#333;">「オブジェクト指向のドラクエ!!」</h1>
  <div style="background:black; padding:15px; position:relative;">
    ...
    <?php } ?>
    <div style="position:absolute; right:-350px; top:0; color:black; width: 300px; height: 520px; overflow-y: scroll;">
